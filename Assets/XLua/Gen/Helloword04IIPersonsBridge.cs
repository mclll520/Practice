...
{
    public class Helloword04IIPersonsBridge : LuaBase, Helloword04.IIPersons
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new Helloword04IIPersonsBridge(reference, luaenv);
		}
		
		public Helloword04IIPersonsBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
